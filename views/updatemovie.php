...
<body>
    ...
    <div class="container">
        <div class="container">
            <h2>Add Movies </h2>
            <form action="../controllers/updatemoviecontroller.php" method="POST">
                <div class="form-group">
                    <label for="title">Enter Movie Unique ID:</label>
                    <input type="text" class="form-control" id="id" placeholder="You MUST Enter correct Moview ID to make Update " name="id" required>
                </div>
                <div class="form-group">
                    <label for="title">Movie Title:</label>
                    <input type="text" class="form-control" id="title" placeholder="Enter new Movie title to update" name="title" required>
                </div>
                <div class="form-group">
                    <label for="title">Movie Duration:</label>
                    <input type="text" class="form-control" id="duration" placeholder="Enter new Movie Movie Durating to update" name="duration" required>
                </div>
                <div class="form-group">
                    <label for="title">Movie Rating:</label>
                    <input type="text" class="form-control" id="rating" placeholder="Enter new Movie Movie Rating to update" name="rating" required>
                </div>
