        ...
        <div class="container">
            ...
            <form action="../controllers/deletecontroller.php" method="POST">
                <div class="form-group">
                    <label for="title">Enter Movie ID:</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter Movie ID to delete" name="id" required>
                </div>
                <button type="submit" class="btn btn-primary">delete Movie List</button>
            </form>
        </div>
    </div>
